...
class MainActivity : BaseActivity() {
    ...
    override fun onStart() {
        ...
        val collectionList = CollectionList(ArrayList(mutableListOf(
                CollectionItem(1, "http://www.baidu.com", R.mipmap.ic_launcher, "test"),
                CollectionItem(1, "http://www.baidu.com", R.mipmap.ic_launcher, "test2"),
                CollectionItem(1, "http://www.baidu.com", R.mipmap.ic_launcher, "test3"),
                CollectionItem(1, "http://www.baidu.com", R.mipmap.ic_launcher, "test4"))))
    ...
    override fun requestData(params: List<Any>) {
        Toast.makeText(this, "click item" + (params[0] as CollectionItem).title, Toast.LENGTH_LONG).show()
        onResultBack("")
    }
